...
| `/download/the-spy-guitar` | Permanent redirect | `/legacy/the-spy-guitar/` | Historic download intent; no binary served |
| `/news/introducing-the-spy-guitar` | Permanent redirect | `/legacy/the-spy-guitar/` | Historic title and path |
| `/download/bang-my-twister-new-m4l-device-for-changing-banks-on-midi-fighter-twister` | Permanent redirect | `/legacy/bang-my-twister/` | Surviving project reference |
